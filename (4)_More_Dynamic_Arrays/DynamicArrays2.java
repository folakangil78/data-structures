...
public class DynamicArrays2 {
     ...
     * default size value.
     */
    public DynamicArrays2(int size) {
     ...
     * @param data
     */
    public DynamicArrays2(String[] data) {
        this(DEFAULT_SIZE);
        if (data != null) {
    ...
    /**
     * returns text represen of dynamic array
     * 
     * @return string rep of dynamic array.
     */
    public String toString() {
        ...
        for (int i = 0; i < this.occupancy; i++) {
            ...
            if (i < this.occupancy - 1) {
                result += ", "; // concatenates element in array as string quantity
            }
        }
        result += "]";
        return result;
    ...
    /**
     * returns index of first occurrence of string in array
     * 
    ...
    public int index(String string) {
        if (string != null && this.foundation != null) {
            for (int i = 0; i < this.occupancy; i++) {
                if (this.foundation[i] != null && this.foundation[i].equals(string)) { // uses .equals to compare strings throughout array
                    return i; // returns index of that first appearance
                }
            }
        }
        return -1;
    ...
    /**
     * returns usage of array as percent of non-null elements contained
     * percent rounded ~2
     * 
     * @return percentage of  array being used
     */
    public double usage() {
        if (this.foundation != null && this.foundation.length > 0) {
            double usage = (double) this.occupancy / this.foundation.length; // math round hint given in instructions
            return Math.round(usage * 100.0)/100.0; // takes amount of non-nulls and divides by total
        } //else:
        return 0.0;
    }
    ...
    public static void main(String[] args) {
        ...
        DynamicArrays2 test = new DynamicArrays2(testData);
    } // method main
